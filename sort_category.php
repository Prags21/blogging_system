...
$cursor= $cursor->sort(array("category"=>1,"name"=>1));
    ?>
...
<ul>
  ...
  <li class="dropdown"><a href="#" class="dropbtn">SORT</a>
      ...
      <a href="../blog/sort_category.php">CATEGORY</a>
    </div>
  </li>
  </ul>

<div id="card" style=" position:fixed;bottom:40px;right:0;">
<form action="subscribe.php" method="post"><p>Subscribe here!!</p></br>
 Name:<input name="name" class="email" type="text" placeholder="Name..."></br>
    E-mail:<input name="email" class="email" type="text" placeholder="Enter your email address ...">
