...
<p><a href="../blog/update_post_pg.php?id=<?php echo $row['_id']; ?>"><input type="submit" value="Update"></a>
<a href="../blog/delete_post.php?id=<?php echo $row['_id']; ?>"><input type="submit" value="Delete"></a></p>
</div>
